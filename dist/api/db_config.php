...
$DB_USER = getenv('DB_USER') ?: getenv('MYSQL_USER') ?: 'root'; // Ganti dengan Username MySQL Hostinger
$DB_PASS = getenv('DB_PASS') ?: getenv('MYSQL_PASSWORD') ?: ''; // Ganti dengan Password MySQL Hostinger
$DB_NAME = getenv('DB_NAME') ?: getenv('MYSQL_DATABASE') ?: 'attaroqqy_db'; // Ganti dengan Nama Database Hostinger
